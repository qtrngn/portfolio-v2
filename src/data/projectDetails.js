...
export const projectDetails = [
    
    {
        ...
        description: "As part of my introduction to React, I built a clone Netflix landing page to practice foundational concepts in component-based design and state management.",
        features: [
            "Reusable components",
            "UI design with CSS",
...

    {
        ...
        description: "This responsive restaurant website was built with HTML, CSS, and JavaScript plugins and optimized for different screen sizes. This project helped me understand responsive design principles and improve my understanding of layout structuring, visual design and basic interactivity without using any frameworks",
        features: [
...

    {
        ...
        description: "The project was part of a UI/UX design course where I analyzed and redesigned the PetSmart mobile application using Figma. The goal was to enhance the user experience for pet owners managing appointments, browsing products, and viewing pet information.",
        features: [
...

    {
        ...
        description: "My introduction to web development began with this project—a basic website created using only HTML and CSS. This school project introduced me to the foundation of web development and marked the beginning of my journey as a developer",
        features: [
            "Simple website",
            "Simple navigation", 
...

    {
        ...
        description: "The weather application using React Native and API integration. The app fetches current weather data using Weather API and display it with clean UI. I used Axios to handle network requests efficiently and integrated Lottie animations to visually represent weather conditions in a fun, interactive way.",
        features: [
...

    {
        ...
        type: "School project",
        title: "Book explorers application", 
        description: "This project is the web-based version of my Book Explorer app, but instead of using a third-party API, I built and managed my own backend using MySQL on MAMP. It features a searchable book database, responsive layout, and dynamic content rendering.",
        features: [
