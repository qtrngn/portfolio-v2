...
export default function InfiniteScroll({
  ...
  return (
    <div
      ...
      style={{ maxHeight }}
    >
      <div className="absolute top-0 left-0 w-full h-1/4 z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 z-10 pointer-events-none"></div>
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-xl font-semibold text-center select-none box-border relative"
            key={i}
            style={{
